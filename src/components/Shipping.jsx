...
export default function Shipping() {
  return (
    <div>
        ...
        <p>Thank you for visiting and shopping at My Website (change this). Following are the terms and conditions that constitute our Shipping Policy.Domestic Shipping Policy</p>
