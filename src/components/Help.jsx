...
export default function Help() {
  return (
    <div>
        ...
        <p>We're sorry',</p> <p>your number one source for all things handmade. We're dedicated to delivering you the very best hand-made products, with a focus on dependability, customer service and uniqueness.
